...
export default function TopBar({ isScrolled }) {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 flex flex-col">
      ...
      <div className="bg-gray-50 border-b border-gray-200 h-8 flex items-center justify-end px-4 sm:px-6 lg:px-8 transition-all duration-300">
        <div className="flex items-center gap-1 w-full max-w-7xl mx-auto justify-end" role="navigation" aria-label="Language switcher">
          {LANGUAGES.map((l) => (
            <button
              key={l.code}
              id={`lang-btn-${l.code}`}
